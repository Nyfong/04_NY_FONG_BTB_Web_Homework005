...
export const HomeCardBook = async () => {
              ...
              <div className="grid grid-cols-3 md:grid-cols-6 h-full">
                ...
                <div className="col-span-2 md:col-span-4 px-6 md:px-8 flex flex-col gap-3 justify-center">
                  ...
                  <p className="text-gray-300 text-sm text-[#0B3954]">
                    The novel's enduring themes of self-discovery and ethical
                    living continue to resonate, prompting reflections on how
                    one should live a meaningful life.
                  </p>
                </div>
              </div>
            </div>
